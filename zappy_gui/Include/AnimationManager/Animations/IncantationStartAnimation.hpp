...
namespace animation
{
    class IncantationStartAnimation : public Animation
    {
    public:
        IncantationStartAnimation(gamestate::TileRef tile)
            : Animation(INCANTATION, tile, 100, false)
        {
        }
        ...
        void keyframe3D(std::size_t frame)
        {
            ...
            try {
                ...
                Bean<ParticleManager>::getInstance().addParticles({pos.x, 1, pos.z}, 1, {0.01, 0.1, 0.01}, MAGENTA, POS);
